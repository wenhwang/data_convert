...
public class FinancialExportController {
    ...
    public Result<List<FinanceReimbursement>> expenseHandler(){
        return  Result.<List<FinanceReimbursement>>success(financialLocalFileService.expenseHandler("1 报销单"));
    }

    @ApiOperation("1.1 报销单明细")
    @GetMapping("/expenseDetail")
    public Result<List<MapCostList>> expenseDetialHandler(){
        return  Result.<List<MapCostList>>success(financialLocalFileService.expenseDetialHandler("1.1 报销单明细"));
    }
    ...
    public Result<List<FinanceRepayment>> repaymentHandler(){
        return  Result.<List<FinanceRepayment>>success(financialLocalFileService.repaymentHandler("2 还款单"));
    }
    ...
    public Result<List<FinanceReserveFund>> reservefundHandler(){
        return  Result.<List<FinanceReserveFund>>success(financialLocalFileService.reserveFundHandler("3 备用金（借款）"));
    }
    ...
    public Result<List<FinanceCapitalAccount>> capitalaccountHandler(){
        return  Result.<List<FinanceCapitalAccount>>success(financialLocalFileService.capitalAccountHandler("4 资金账号"));
    }
   ...
   //外经证 businesslicense  finance_business_license
    ...
    public Result<List<FinanceBusinessLicense>> businessLicenseHandler(){
        return  Result.<List<FinanceBusinessLicense>>success(financialLocalFileService.businessLicenseHandler("5 外经证"));
    }
    ...
    public Result<List<MapHandover>> businessLicenseHandoverHandler(){
        return  Result.<List<MapHandover>>success(financialLocalFileService.businessLicenseHandoverHandler("5.1 外经证交接信息"));
    }
    //外经证完税信息
    @ApiOperation("5.2 外经证-完税信息")
    @GetMapping("/license-payTax")
    public Result<List<MapPayTax>> businessLicensePayTaxHandler(){
        return  Result.<List<MapPayTax>>success(financialLocalFileService.businessLicensePayTaxHandler("5.2 外经证完税信息"));
    }
    ...
    public Result<List<FinanceReceiveInvoice>> receiveInvoiceHandler(){
        return  Result.<List<FinanceReceiveInvoice>>success(financialLocalFileService.receiveInvoiceHandler("6 收票"));
    }

    @ApiOperation("6.1 收票-收票明细")
    @GetMapping("/receiveinvoice-detail")
    public Result<List<MapInvoice>> receiveInvoiceDetailHandler(){
        return  Result.<List<MapInvoice>>success(financialLocalFileService.receiveInvoiceDetailHandler("6.1 收票 - 发票明细"));
    }

    @ApiOperation("6.2 收票-商品明细")
    @GetMapping("/receiveinvoice-prod")
    public Result<List<MapCommodity>> receiveInvoiceProdsHandler(){
        return  Result.<List<MapCommodity>>success(financialLocalFileService.receiveInvoiceProdsHandler("6.2 收票 - 商品明细"));
    }
    ...
    public Result<List<FinanceOpenInvoice>> openInvoiceHandler(){
        return  Result.<List<FinanceOpenInvoice>>success(financialLocalFileService.openInvoiceHandler("7 开票"));
    }
    //开票-发票明细
    @ApiOperation("7.1 开票-开票明细")
    @GetMapping("/openinvoice-details")
    public Result<List<MapOpenInvoice>> openInvoiceDetailHandler(){
        return  Result.<List<MapOpenInvoice>>success(financialLocalFileService.openInvoiceDetailHandler("7.2 开票 - 发票明细"));
    }
    //开票-商品明细
    @ApiOperation("7.2 开票-商品明细")
    @GetMapping("/openinvoice-prod")
    public Result<List<MapOpenCommodity>> openInvoiceProdsHandler(){
        return  Result.<List<MapOpenCommodity>>success(financialLocalFileService.openInvoiceProdsHandler("7.1 开票 - 商品明细"));
    }
    ...
    public Result<List<FinanceAdjustment>> adjustmentHandler() {
        return Result.<List<FinanceAdjustment>>success(financialLocalFileService.adjustmentHandler("14 往来管理（调整单）"));
    }
    ...
    public Result<List<FinanceReceivables>> receivablesHandler(){
        return  Result.<List<FinanceReceivables>>success(financialLocalFileService.receivablesHandler("13 收款"));
    }
    ...
    public Result<List<FinanceDrawMoney>> drawMoneyHandler(){
        return  Result.<List<FinanceDrawMoney>>success(financialLocalFileService.drawMoneyHandler("12 划款（扣款）"));
    }
}
