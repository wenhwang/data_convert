...
public class FinanceOpenInvoice {
     ...
     */
    private String openInvoiceId = StringUtils.EMPTY;
    /**
     * 开票编号
     *
     ...
     */
    private String statementNumber = StringUtils.EMPTY;
    /**
     * 项目id
     *
     ...
     */
    private double overInvoiceAmount;
    /**
     * 申请开票金额
     *
     * @pdOid eb81c6a4-5f7c-44ca-9003-52421c183f58
     */
    private double applyInvoiceAmount;
    /**
     * 实际开票金额
     *
     ...
     */
    private String invoiceBasis = StringUtils.EMPTY;
    /**
     * 是否推送到收款申请单 0：是 1：否
     *
