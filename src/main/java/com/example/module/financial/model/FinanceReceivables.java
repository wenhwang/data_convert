...
public class FinanceReceivables {
     ...
     */
    @ExcelProperty("收款单ID") private String receivablesId = StringUtils.EMPTY;
    /**
     * 收款单编号
     *
     * @pdOid 64910b0e-dbd4-4ec8-bb55-f4823a3d1b85
     */
    @ExcelProperty("收款单编号") private String sysNumber = StringUtils.EMPTY;
    /**
     * 项目id
     *
     ...
     */
    @ExcelProperty("合同金额") private String contractAmount = StringUtils.EMPTY;
    /**
     * 收款类型id
     *
     * @pdOid a562d859-c5fb-4ac9-b4c3-c1a81a9a889c
     */
    @ExcelProperty("收款类型id") private String receivablesTypeId = StringUtils.EMPTY;
    /**
     * 收款类型名称
     *
     * @pdOid f22775f2-753b-48cf-8da3-c31867df21cb
     */
    @ExcelProperty("收款类型名称") private String receivablesTypeName = StringUtils.EMPTY;
    /**
     * 款项类别id
     *
     * @pdOid 61d35869-4669-4842-bb33-3580050d88b3
     */
    @ExcelProperty("款项类别id") private String typeId = StringUtils.EMPTY;
    /**
     * 款项类别名称
     *
     * @pdOid 3b0de9a9-035b-4a4f-925c-9c83bb3539c1
     */
    @ExcelProperty("款项类别名称") private String typeName = StringUtils.EMPTY;
    /**
     * 收款单位
     *
     ...
     */
    @ExcelProperty("累计结算金额") private double totalSettlementAmount;
    /**
     * 计划收款金额
     *
     * @pdOid 9e7a7f1f-ed06-46e4-903e-0d1fa62667b3
     */
    @ExcelProperty("计划收款金额") private double estimateReceivablesAmount;
    /**
     * 累计收款金额
     *
     * @pdOid 6ffb352d-6799-453d-aa6f-f78a3211c96e
     */
    @ExcelProperty("累计收款金额") private double totalReceivablesAmount;
    /**
     * 实际收款金额
     *
     * @pdOid 1322c408-7933-4a59-bd2c-ce634d4aa68e
     */
    @ExcelProperty("实际收款金额") private double actualReceivablesAmount;
    /**
     * 实际收款日期
     *
     * @pdOid bb8031f1-8867-4e52-9ff4-aeabf24eb1ec
     */
    @ExcelProperty("实际收款日期") private String actualReceivablesDate = StringUtils.EMPTY;
    /**
     * 合伙人id
     *
     ...
     */
    @ExcelProperty("摘要") private String _abstract = StringUtils.EMPTY;
    /**
     * 备注
     *
     ...
     */
    @ExcelProperty("是否推送开票申请单") private String isPush = StringUtils.EMPTY;
    /**
    ...
    @ExcelProperty("预算项目id") private String	budgetProjectId = StringUtils.EMPTY;
    @ExcelProperty("预算项目名称") private String	budgetProjectName = StringUtils.EMPTY;
    @ExcelProperty("收款账户id") private String	receivablesAccountId = StringUtils.EMPTY;

    @ExcelProperty("") private String dataSource = "EPMS";
}