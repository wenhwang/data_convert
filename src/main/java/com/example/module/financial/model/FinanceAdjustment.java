...
public class FinanceAdjustment {
     ...
     */
    private String adjustmentId = StringUtils.EMPTY;
    /**
     * 调整单业务号
     *
     ...
     */
    private String objectName = StringUtils.EMPTY;
    /**
     * 调整前对象
     *
     * @pdOid 7b0d0719-6a5b-4dd9-96f4-dc2d03235bb9
     */
    private String overObject = StringUtils.EMPTY;
    /**
     * 调整后对象
     *
     * @pdOid d7c2751c-61f0-4ca1-afcc-44133ce1860a
     */
    private String afterObject = StringUtils.EMPTY;
    /**
     * 申请日期
     *
     ...
     */
    private String applyDepartmentId = StringUtils.EMPTY;
    /**
     * 申请部门名称
     *
     * @pdOid 50d69672-5d61-48bc-9389-0dbd1de9e450
     */
    private String applyDepartmentName = StringUtils.EMPTY;
    /**
     * 调整金额
     *
