...
public class FinanceBusinessLicense {
     ...
     */
    @ExcelProperty("外经证编号") private String sysNumber = StringUtils.EMPTY;
    /**
     * 项目id
     *
     ...
     */
    @ExcelProperty("项目编号") private String projectNumber = StringUtils.EMPTY;
    /**
     * 合同ID
     *
     ...
     */
    @ExcelProperty("业主id") private String ownerId = StringUtils.EMPTY;
    /**
     * 业主名称
     *
     * @pdOid 1f66067b-30ca-47e1-8718-fe502051f826
     */
    @ExcelProperty("业主名称") private String ownerName = StringUtils.EMPTY;
    /**
     * 合伙人id
     *
     ...
     */
    @ExcelProperty("领用人") private String receiveUser = StringUtils.EMPTY;
    /**
     * 外经证开具地址
     *
     * @pdOid d9bfb4c0-78db-4ccf-b4ed-39fbd8107a90
     */
    @ExcelProperty("外经证开具地址") private String address = StringUtils.EMPTY;
    /**
     * 完税税务局名称
     *
     * @pdOid 3a454c2d-64fc-4b91-8b3e-a9ddcd8cb2ed
     */
    @ExcelProperty("完税税务局名称") private String taxBureauName = StringUtils.EMPTY;
    /**
     * 已开具金额
     *
     * @pdOid 4d99c162-b295-4d7c-8ebd-6d66a19f81ec
     */
    @ExcelProperty("已开具金额") private double overOpenAmount;
    /**
     * 申请开具金额
     *
     * @pdOid 6b4990b2-f975-425d-ba6e-75a1777dfed4
     */
    @ExcelProperty("申请开具金额") private double applyOpenAmount;
    /**
     * 实际开具金额
     *
     * @pdOid cf44a6b5-9e1d-4ac2-baec-ac94ca5bdbca
     */
    @ExcelProperty("实际开具金额") private double actualOpenAmount;
    /**
     * 累计开具金额
     *
     * @pdOid 7efd69bd-65e5-42af-9a22-a6aa3b729f1b
     */
    @ExcelProperty("累计开具金额") private double totalOpenAmount;
    /**
     * 外经证编码
     *
     * @pdOid be7e98ee-4e8f-4c72-a45c-b60813427444
     */
    @ExcelProperty("外经证编码") private String businessLicenseNumber = StringUtils.EMPTY;
    /**
     * 失效时间
     */
    @ExcelProperty("失效时间") private Date endDate;

    /**
     * 生效时间
     */
    @ExcelProperty("生效时间") private Date startDate;
    /**
     * 附件集合
     *
     ...
     */
    @ExcelProperty("外经证状态") private String status = StringUtils.EMPTY;
    /**
     * 是否删除 1:是；0:否
     *
