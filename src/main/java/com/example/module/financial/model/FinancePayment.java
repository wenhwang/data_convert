...
public class FinancePayment {
     ...
     */
    private String paymentId = StringUtils.EMPTY;
    /**
     * 付款编号
     *
     ...
     */
    private String projectAddress = StringUtils.EMPTY;
    /**
     * 合同ID
     *
     ...
     */
    private String actualPaymentDate = StringUtils.EMPTY;
    /**
     * 账套主体
     *
     ...
     */
    private String invoiceTypeId = StringUtils.EMPTY;
    /**
     * 发票种类名称
     *
     * @pdOid 0fa50f5d-e9a4-45d3-9d3f-2d0628abb47d
     */
    private String invoiceTypeName = StringUtils.EMPTY;
    /**
     * 发票业务类型id
     *
     ...
     */
    private String moneyCategoryId = StringUtils.EMPTY;
    /**
     * 款项类别名称
     *
     * @pdOid d75d6b5b-7c04-41fb-b99f-9de94455eb95
     */
    private String moneyCategoryName = StringUtils.EMPTY;
    /**
     * 款项类型id
     *
     * @pdOid be6f8c12-c4a3-4c9d-b8f1-5519f8220be4
     */
    private String moneyTypeId = StringUtils.EMPTY;
    /**
     * 款项类型名称
     *
     * @pdOid 0344b5ef-af2e-4e99-b0a5-887035863ba2
     */
    private String moneyTypeName = StringUtils.EMPTY;
    /**
     * 付款依据id
     *
     * @pdOid f803ce1d-3612-4fe2-9e34-d78adbec9599
     */
    private String paymentBasisId = StringUtils.EMPTY;
    /**
     * 付款依据名称
     *
     * @pdOid 1fbf62ea-07c8-46b8-b68a-e5455b043d95
     */
    private String paymentBasisName = StringUtils.EMPTY;
    /**
     * 预算类别id
     *
     * @pdOid 7169910e-99f9-4103-87a6-9bd82b0f6aca
     */
    private String budgetTypeId = StringUtils.EMPTY;
    /**
     * 预算类别名称
     *
     * @pdOid b7c51099-28c8-43b0-b3ff-2137f912cc86
     */
    private String budgetTypeName = StringUtils.EMPTY;
    /**
     * 支付方式id
     *
     ...
     */
    private String payWayName = StringUtils.EMPTY;
    /**
     * 合伙人id
     *
